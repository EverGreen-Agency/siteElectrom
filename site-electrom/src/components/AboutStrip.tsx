      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="border border-white/5 bg-brand-petrol/60 backdrop-blur-md rounded-3xl p-8 lg:p-12 relative overflow-hidden">
          <div className="mb-10 flex justify-between items-center flex-wrap gap-4 border-b border-white/5 pb-6">
            <div>
              <span className="text-[10px] font-mono tracking-widest text-brand-cyan uppercase font-semibold">HISTÓRIA INTERATIVA</span>
              ...
              {milestones.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span 
                      className={`absolute -bottom-8 font-mono text-xs font-semibold transition-colors duration-300 ${
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="lg:col-span-7 space-y-4">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-mono tracking-widest text-brand-cyan uppercase font-semibold">
                    {milestones[activeIdx].tag}
                  </div>
                  <h4 className="text-2xl md:text-4xl font-display font-bold text-white leading-tight">
                    {milestones[activeIdx].title} <span className="text-brand-blue font-mono font-normal">({milestones[activeIdx].year})</span>
                  </h4>
                  <p className="text-gray-300 font-normal text-base leading-relaxed max-w-xl">
